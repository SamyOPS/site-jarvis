...
export const About3 = ({
  ...
  breakout = {
    ...
    description:
      "Support, développement et sécurité assurés par une équipe senior qui s'aligne sur vos enjeux.",
  },
  ...
  return (
    <section className="bg-white pt-16 pb-10 text-[#0A1A2F] md:pt-20 md:pb-12">
      <div className="container mx-auto px-6 lg:px-10">
        ...
        <div className="grid gap-7 lg:grid-cols-2 lg:items-center">
          <img
            src={mainImage.src}
            alt={mainImage.alt}
            className="size-full max-h-[620px] rounded-none object-cover"
          />
      ...
      <div className="mt-12 bg-[#050B14] px-6 py-12 text-white md:mt-16 md:px-10 md:py-16">
        <div className="mx-auto flex max-w-6xl flex-col gap-10 md:flex-row md:items-start md:justify-between">
          ...
          <div className="grid flex-1 grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
            {companies.map((company, idx) => (
              <div
                className="flex h-28 items-center justify-center border border-white/15 bg-white/5 px-4 py-3 transition hover:-translate-y-1 hover:border-white/40"
                key={company.alt + idx}
              >
                <img
                  src={company.src}
