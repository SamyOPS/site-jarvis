...
type DashboardSessionCardProps = {
  ...
  /**
   * Habillage de la carte. Les espaces admin et pro ne differaient que par ce detail
   * (`shadow-lg backdrop-blur` contre `shadow-sm`) : chacun le passe explicitement,
   * pour qu'aucun des deux ne devienne un defaut implicite.
   */
  className?: string;
};
...
export function DashboardSessionCard({
  ...
  return (
    <Card className={cn("border-slate-200 bg-white text-[#0A1A2F]", className)}>
