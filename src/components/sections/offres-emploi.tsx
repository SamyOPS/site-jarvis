  ...
  return (
    <section className="relative overflow-hidden bg-[#F4F7FA] py-16 text-[#0A1A2F]">
      ...
      <div className="container mx-auto px-6 lg:px-10 xl:px-16">
        <motion.div
          className="relative overflow-hidden rounded-[28px] border border-[#2aa0dd]/20 bg-white px-6 py-8 shadow-[0_24px_70px_rgba(10,26,47,0.10)] md:px-10 md:py-10"
        ...
        >
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="max-w-3xl space-y-3">
              <p className="text-xs font-bold uppercase tracking-[0.22em] text-[#2aa0dd]">
                Recrutement
              </p>
