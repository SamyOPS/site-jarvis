    ...
    <>
      <div className="min-h-screen bg-[#eaedf0] text-[#2f3b42]">
        <main className="particle-readability mx-auto max-w-6xl px-6 pt-16 pb-24 lg:pt-24 lg:pb-32">
          ...
          <section className="grid gap-8 rounded-2xl border border-[#d5d9dc] bg-white p-6 shadow-sm lg:grid-cols-[1.1fr_0.9fr] lg:p-8">
            <div className="space-y-4">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                <div className="rounded-xl border border-[#d5d9dc] bg-[#f7f9fb] p-4">
                  <div className="mb-2 flex items-center gap-2 text-[#2aa0dd]">
          ...
          <section className="mt-6 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="flex h-full flex-col rounded-2xl border border-[#d5d9dc] bg-white p-6 shadow-sm lg:p-8">
              <p className="text-sm uppercase tracking-[0.2em] text-[#3c4e58]/70">
                {"Objectifs"}
              </p>
              ...
              <ul className="mt-6 space-y-4">
                {objectives.map((item) => (
                  <li key={item} className="flex items-start gap-3.5 text-[15px] text-[#4f5e66] leading-7">
                    <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-[#2aa0dd]" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="rounded-2xl border border-[#d5d9dc] bg-white p-6 shadow-sm lg:p-8">
              <p className="text-sm uppercase tracking-[0.2em] text-[#3c4e58]/70">
                {"Programme"}
              </p>
              <h2 className="mt-2 text-2xl font-semibold text-[#2f3b42]">
              ...
              <div className="mt-5 space-y-4">
                {program.map((block, index) => (
                  <div key={block.title} className="rounded-xl border border-[#d5d9dc] bg-[#f7f9fb] p-4">
                    <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#2aa0dd]">
                      {`Etape ${index + 1}`}
                    </p>
          ...
          <section className="mt-6 rounded-2xl border border-[#d5d9dc] bg-white p-6 shadow-sm lg:p-8">
