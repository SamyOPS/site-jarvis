...
function HoverSliderDetails({ slides }: { slides: CybersecuriteSlide[] }) {
...
export function CybersecuriteHoverSlider({ slides }: { slides: CybersecuriteSlide[] }) {
  return (
